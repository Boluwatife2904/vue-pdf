...
const absPath: any = (_absPath as any).default ?? _absPath;
const parsePath: any = (_parsePath as any).default ?? _parsePath;
const normalizePath: any = (_normalizePath as any).default ?? _normalizePath;
