import * as _parse from 'postcss-value-parser/lib/parse.js';
import * as _parseUnit from 'postcss-value-parser/lib/unit.js';
const parse: any = (_parse as any).default ?? _parse;
const parseUnit: any = (_parseUnit as any).default ?? _parseUnit;
