import * as _hslToHex from 'hsl-to-hex';
import * as _colorString from 'color-string';
const hlsToHex: any = (_hslToHex as any).default ?? _hslToHex;
const colorString: any = (_colorString as any).default ?? _colorString;
